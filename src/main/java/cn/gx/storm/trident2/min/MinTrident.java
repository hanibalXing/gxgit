package cn.gx.storm.trident2.min;

import cn.gx.storm.trident2.max.NoTransactionalBatchSpout;
...
public class MinTrident
{

    private static final Logger LOG = LoggerFactory.getLogger(MinTrident.class);
